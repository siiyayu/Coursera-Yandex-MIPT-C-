...
vector<Sentence<Token>> SplitIntoSentences(vector<Token> tokens) {
    ...
    for (int i = 0; i < tokens.size(); i++) {
        ...
        result[k].push_back(move(tokens[i]));
    }
    return result;
}
...
//    TestToken(TestToken&& other) : data(other.data), is_end_sentence_punctuation(other.is_end_sentence_punctuation) {
//        other.data = nullptr;
//        is_end_sentence_punctuation = false;
//    }
